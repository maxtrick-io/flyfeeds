...
// $("body").append(tela);
$(".title-hook").append(c3.canvas);
writeText(c2.canvas, c2.context, "hook")
...
class Particle{
  constructor(canvas, options){
    ...
    this.color  = this.radius > 5 ? "#FFF": this.randomColor() //this.randomColor()
  }

  randomColor() {
    let colors = ["#FF41CA", "#5F007F","#2335BE","#C321A5","#FFF"];
...
function writeText(canvas, context, text){
  let size = 200
  context.font =  size + "px abstract_moon";
